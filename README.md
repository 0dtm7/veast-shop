...
- Меню Telegram-бота с кнопками статуса заказа, привязки, поддержки и сайта.
...
Баннер стартового меню бота хранится в `assets/bot/veast-order-bot-banner.png`. При необходимости можно переопределить ссылку через переменную `VEAST_BOT_BANNER_URL`.
